...
import PageLayout from "@/app/page-layout"; // ✅ 1. Importar o Layout
...
const MAIN_CATALOG_ID = "clxrz8hax00003b6khe69046c";
...
export default async function VitrinePage() {
  ...
  // ✅ 2. Envolver o conteúdo com PageLayout para mostrar o Menu e o Rodapé
  return (
    <PageLayout>
      <HomeContent featuredProducts={formattedProducts} allCategories={categories} />
    </PageLayout>
  );
}