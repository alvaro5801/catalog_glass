...
  isFeatured: false,
  categoryId: 'cat_1',
  catalogId: MOCK_CATALOG_ID, // <-- Correto para dados LIDOS
...
  priceInfo: '...',
  isFeatured: false,
  // catalogId: MOCK_CATALOG_ID, // <-- O ERRO ESTAVA AQUI

  // --- ✅ CORREÇÃO 1 (Que já tínhamos) ---
  category: {
    connect: {
      id: 'cat_1'
    }
  },
  ...
  // --- ✅ CORREÇÃO 2 (A nova correção) ---
  // Substituímos 'catalogId' pelo objeto de conexão da relação 'catalog'
  catalog: {
    connect: {
      id: MOCK_CATALOG_ID
    }
...
      
      const product = await productService.createProduct(mockCreateData); // Usar os dados corrigidos
